...
const Feedbacks = () => {
  return (
    <div className="relative">
      ...
      {/* Top right corner glow effect - more diffused */}
      <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-gradient-radial from-violet-300/25 via-purple-400/15 to-transparent blur-3xl"></div>
      <div className="absolute -top-20 -right-20 w-[500px] h-[500px] bg-gradient-to-br from-violet-200/20 via-purple-300/10 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-bl from-violet-300/15 to-transparent rounded-full blur-2xl"></div>
